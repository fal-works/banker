...
abstract NaiveVector<T>(NaiveVectorData<T>) {
	 ...
	 */
	public static inline function blit<T>(source:NaiveVector<T>, sourcePosition:Int, destination:NaiveVector<T>, destinationPosition:Int,
		...
		destination.data.blit(destinationPosition, source.data, sourcePosition, rangeLength);
	}
	 ...
	 * @return Filled `this`.
	 */
	public inline function fillRange<T>(value:T, startIndex:Int, endIndex:Int):NaiveVector<T> {
